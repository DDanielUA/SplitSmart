...
import com.SplitSmart.Logic.ActionObserver.Action;
...
public class WelcomeView extends JFrame implements ActionListener
{
    ...
    private ActionAgency observer;

    public WelcomeView(){

    }

    public WelcomeView(ActionAgency observer)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==log)
        {
            this.observer.Notify(Action.LogInPressed);
        ...
        if(e.getSource()==reg)
        {
            this.observer.Notify(Action.RegisterPressed);
            welcomeFrame.dispose();
            //regView.displayView();
        }
    }
